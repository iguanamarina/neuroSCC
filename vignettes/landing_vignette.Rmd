---
title: "Getting Started with neuroSCC: Data Preparation and Basic Setup"
...
```r
remotes::install_github("Triangulation_package_link_here")
```

Conditional example for triangulation:

```{r, eval = requireNamespace("Triangulation", quietly = TRUE)}
