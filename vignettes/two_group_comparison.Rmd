...
```{r}
# Check and conditionally prepare necessary data
if (!exists("normalizedControls") || !exists("normalizedPathological") || !exists("contours")) {
  cat("Necessary objects not found. Creating data from provided samples...\n")

  # Create databases from provided sample files (2 controls and 2 pathological subjects)
  ...
  # Extract contours from one control subject (required for SCC analysis)
  ...
  cat("All required data objects already exist. Proceeding...\n")
}
```
