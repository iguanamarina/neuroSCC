...
#'
#' # Evaluate Poisson clone generation on reduced example
#' with(generatePoissonClonesExample, {
#'   set.seed(123)
#'   sampledCols <- sample(ncol(.), 10)
#'   clone <- generatePoissonClones(., numClones = 1, lambdaFactor = 0.25)
#'   clone[, sampledCols]
#' })
#'
#' @export
