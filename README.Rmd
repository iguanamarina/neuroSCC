...
🚀 **`neuroSCC`** facilitates **structured processing of PET neuroimaging data** for the estimation of **Simultaneous Confidence Corridors (SCCs)**.  
...
The package bridges **neuroimaging tools** (`oro.nifti`) with advanced **statistical methods** (`ImageSCC`), supporting **one-group, two-group, and single-patient vs. group comparisons**.
...
<p>
  ...
  <img src="`r badge_url_contributors`" alt="Contributors" />
