...
`plotSCC()` generates a **heatmap visualization of SCC values**, with the option to **overlay significant detected points**. This function helps interpret SCC results by highlighting **regions where detected differences exceed confidence bands**.
